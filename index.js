...
function showProjects(technology) {
    ...
    if (apps[technology].length === 0) {
        ...
        appList.appendChild(lottieContainer);
        ...
        lottie.loadAnimation({
            ...
            loop: true,
            autoplay: true,
            path: 'https://assets10.lottiefiles.com/packages/lf20_yyjaansa.json' // Under development Lottie animation
        });

        // Add a message to indicate no projects are available
        const noProjectsMessage = document.createElement('p');
        noProjectsMessage.textContent = 'No projects available for this technology yet.';
        noProjectsMessage.style.textAlign = 'center';
        noProjectsMessage.style.marginTop = '20px';
        noProjectsMessage.style.color = '#000'; // Ensure text is visible
        noProjectsMessage.style.fontSize = '16px'; // Increase font size for better visibility
        appList.appendChild(noProjectsMessage);

        // Ensure the container is visible
        appList.style.display = 'block';
        appList.style.minHeight = '400px'; // Provide enough space for the animation and message
    } else {
